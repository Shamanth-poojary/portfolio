      ...
      <div className="w-full max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 w-full items-start">
          ...
          >
            ...
            <div>
              <a href="mailto:shamanthpoojary111@gmail.com" className="glass-button inline-flex items-center gap-2 px-7 py-3.5 rounded-full font-body text-sm font-medium decoration-none w-auto">
                Send a message
          ...
          {isMounted ? (
            <motion.div 
              ...
              className="glass-card p-6 md:p-8 rounded-2xl flex flex-col gap-4"
            >
            ...
            <div className="glass-card p-6 md:p-8 rounded-2xl flex flex-col gap-4 opacity-0 h-[400px]"></div>
          )}
        </div>
      </div>
    </section>
